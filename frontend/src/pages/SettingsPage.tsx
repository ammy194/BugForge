            ...
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <div>
                ...
                <CardDescription className="text-xs">
                  Automatically generate random realistic bugs every 1 minute in a continuous loop to simulate a live, active engineering environment during presentations.
                </CardDescription>
              </div>
